...
import myproject.shoppingmall.global.security.handler.CustomAuthenticationFailureHandler;
import myproject.shoppingmall.global.security.handler.CustomAuthenticationSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .authorizeRequests()
                .antMatchers("/", "/test", "/member/new", "/login*", "/logout", "/error").permitAll()
